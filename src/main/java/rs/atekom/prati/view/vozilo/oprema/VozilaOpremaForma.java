...
public class VozilaOpremaForma extends OpstaForma implements OpstaFormaInterface{
	...
	public void izmeniPodatak(Object podatak) {
		...
		if(podatak == null) {
			...
			oprema = (VozilaOprema)podatak;
			postaviPodatak(oprema);
		}
	...
	public Object sacuvajPodatak(Object podatak) {
		...
		oprema.setSistemPretplatnici(pretplatnici.getValue());
		oprema.setNaziv(naziv.getValue());
		oprema.setOpis(opis.getValue());
		oprema.setIzbrisan(izbrisan.getValue());
		return oprema;
	}
	...
	public void postaviPodatak(Object podatak) {
		...
		if(oprema.getId() != null) {
			...
			try {
				naziv.setValue(oprema.getNaziv());
			}catch (Exception e) {
				naziv.setValue("");
			}
			try {
			...
			izbrisan.setValue(oprema.isIzbrisan());
		}
	}
	...
	public boolean proveraPodataka() {
		...
		if(naziv.getValue() == null || naziv.getValue().equals("")) {
			sveIma = false;
		}
		return sveIma;
	}
