...
public class DoRegistracijeIzvestaj extends PrintPreviewReport<Vozila>{
	...
	public DoRegistracijeIzvestaj(ArrayList<Objekti> objekti, int tipServisa, int doServisa) {
		...
		.setTitle("Преглед возила за регистрацију")
		.setGrandTotalLegend("укупно")
		.addAutoText("Преглед возила за регистрацију за мање од " + doServisa + " дана" , AutoText.POSITION_HEADER, AutoText.ALIGMENT_LEFT, 450, headerStyle)
		...
		.addColumn(ColumnBuilder.getNew()
				...
				.build())
		.addColumn(ColumnBuilder.getNew()
				.setColumnProperty("datumRegistracije", Date.class)
				.setTitle("датум прве регистрације")
				.setStyle(datum)
				.setWidth(25)
				.build())
		.addColumn(ColumnBuilder.getNew()
				.setColumnProperty("datumPoslednjeRegistracije", Date.class)
				.setTitle("датум последње регистрације")
				.setStyle(datum)
				.setWidth(25)
				.build())
		.addColumn(ColumnBuilder.getNew()
				.setColumnProperty("danaOdRegistracije", Integer.class)
				.setTitle("дана")
				.setStyle(broj)
				.setWidth(12)
				.build());
