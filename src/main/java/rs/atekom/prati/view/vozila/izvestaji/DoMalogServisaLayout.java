...
public class DoMalogServisaLayout extends VerticalLayout{
	...
	public DoMalogServisaLayout(ArrayList<Objekti> objekti, int tipServisa, int doServisa) {
		...
		izvestaj.downloadPdfOnClick(pdf, "za_mali_servis_" + datumVreme.format(new Date()) + ".pdf", izvestaj.vratiSeriju());
		izvestaj.downloadDocxOnClick(doc, "za_mali_servis_" + datumVreme.format(new Date()) + ".doc", izvestaj.vratiSeriju());
		izvestaj.downloadXlsOnClick(xls, "za_mali_servis_" + datumVreme.format(new Date()) + ".xlsx", izvestaj.vratiSeriju());
