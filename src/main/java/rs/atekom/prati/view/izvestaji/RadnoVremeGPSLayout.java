...
public class RadnoVremeGPSLayout extends VerticalLayout{
	...
	public RadnoVremeGPSLayout(Objekti objekat, Timestamp datumVremeOd, Timestamp datumVremeDo, int satiOd, int satiDo) {
		...
		izvestaj.downloadPdfOnClick(pdf, "radno_vreme_" + datumVreme.format(new Date()) + ".pdf", izvestaj.vratiSeriju(objekat, datumVremeOd, datumVremeDo, satiOd, satiDo));
		//izvestaj.downloadDocxOnClick(doc, "radno_vreme_"" + datumVreme.format(new Date()) + ".doc", izvestaj.vratiSeriju(objekat, datumVremeOd, datumVremeDo));
		//izvestaj.downloadXlsOnClick(xls, "radno_vreme_"" + datumVreme.format(new Date()) + ".xlsx", izvestaj.vratiSeriju(objekat, datumVremeOd, datumVremeDo));
