...
public class SimCombo extends ComboBox<Sim>{

	private static final long serialVersionUID = 1L;

	public SimCombo(SistemPretplatnici pretplatnici, Organizacije organizacija, Sim sim, String naziv, boolean prazno, boolean indicator) {
		setCaption(naziv);
